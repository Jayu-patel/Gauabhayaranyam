...
export default function DownloadSection() {
  return (
    <div className='w-[85%] mx-auto gap-5 lg:gap-1 flex flex-col-reverse lg:flex-row my-2 md:pb-8 scroll-mt-18' id='download'>
        ...
        <div className='lg:flex-3 flex-1 flex items-center md:ml-20'>
            <div>
                ...
                <p className='text-[#4F4F4F] text-[1.10rem] lg:text-[1.20rem] lg:w-[70%] sm:w-[85%] my-3'>
